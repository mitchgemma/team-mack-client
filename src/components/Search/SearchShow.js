...
import { createFavorite } from '../../api/favorites.js'
  ...
  if (showResult.type === 'band') {
    return (
      <>
        <Card style={{ width: '30%' }} className="m-2">
          <Card.Header>{showResult.name}</Card.Header>
          <Card.Body>
            <Card.Text>
        ...
        <Link style={{ textDecoration: 'none' }} to={`/search`}>
          <Button onClick={() => createTheFavorite()}>Favorite!</Button>
        </Link>
      </>
    )
    ...
    return (
      <>
        <Card style={{ width: '30%' }} className="m-2">
          {showResult.name}
          <Card.Header>{showResult.short_title}</Card.Header>
          <Card.Body>
            <Card.Text>{showResult.datetime_local}</Card.Text>
          </Card.Body>
        </Card>
        <Link style={{ textDecoration: 'none' }} to={`/search`}>
          <Button>Back to search</Button>
    ...
    return (
      <>
        <Card style={{ width: '30%' }} className="m-2">
          ...
          <Card.Body>
            <Card.Text>{showResult.url}</Card.Text>
          </Card.Body>
        </Card>
        <Link style={{ textDecoration: 'none' }} to={`/search`}>
          <Button>Back to search</Button>
